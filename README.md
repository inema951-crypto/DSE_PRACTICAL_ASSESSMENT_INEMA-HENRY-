...
**Method:** `POST`  
**URL:** `http://localhost:3005/api/parking/entry`  
**Headers:**
```
Content-Type: application/json
...
**Method:** `PUT`  
**URL:** `http://localhost:3005/api/parking/exit/1`  
**Headers:**
```
Content-Type: application/json
Authorization: Bearer YOUR_TOKEN_HERE
...
**Method:** `GET`  
**URL:** `http://localhost:3005/api/parking/parked-vehicles`  
**Headers:**
```
Authorization: Bearer YOUR_TOKEN_HERE
```
...
**Method:** `GET`  
**URL:** `http://localhost:3005/api/reports/daily?date=2024-12-17`  
**Headers:**
```
Authorization: Bearer YOUR_TOKEN_HERE
```
